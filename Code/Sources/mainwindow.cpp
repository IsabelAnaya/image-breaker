...
MainWindow::MainWindow(Messages messages, QWidget *parent) : QMainWindow(parent) {
    ...
    //current directory
    exportingToLabel = new QLabel(this);
    currDirectoryLabel = new QLabel(this);
    QFileDialog dialog;
    exportingToLabel->setText("Exporting to:");
    initialPath = dialog.directory().absolutePath();
    ...
    layout->addWidget(exportingToLabel);
...
void MainWindow::openImage() {
    ...
    if (currentFileName != "") {
        fileSelectedLabel->setText(currentFileName);
...
void MainWindow::readPreferences() {
    ...
    if (file.is_open()) {
        ...
        std::getline(file, temp);
        currDirectoryLabel->setText(QString::fromStdString(temp));
        file.close();
        ...
        fileExtension = ".raw";
        currDirectoryLabel->setText(dialog.directory().absolutePath());
    }
}
